 ...
 */
const index5 = stations.indexOf("North Berwick");
stations[index5] = "Berwick-upon-Tweed";
 ...
 */
const index6 = stations.indexOf("Leeds");
    stations.splice(index6, 1);
...
const yorkIndex = stations.indexOf("York");
stations.splice(yorkIndex,0, "Darlington");
console.log(stations);
...
if(stoppingAtDurham == -1){
    console.log("oh no it doesn't stop at durham");   
}
else {
console.log("WOHOO it stops at durham");
}
